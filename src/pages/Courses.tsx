...
// //               <div className="flex space-x-2 space-x-reverse">
// //                 {canAccessCourse(course) ? (
// //                   <Link to={`/course/${course.courseId}`} className="flex-1 bg-green-600 text-white text-center py-2 px-4 rounded-md hover:bg-green-700 transition-colors">
// //                     כניסה לקורס
// //                   </Link>
// //                 ) : (
// //                   <Link to={`/purchase/${course.courseId}`} className="flex-1 bg-blue-600 text-white text-center py-2 px-4 rounded-md hover:bg-blue-700 transition-colors flex items-center justify-center space-x-1 space-x-reverse">
// //                     <ShoppingCart className="h-4 w-4" />
// //                     <span>לרכישה</span>
// //                   </Link>
// //                 )}
...
//   // רק מורה שיצר את הקורס יכול להיכנס אליו ישירות
//   // מורה שרוצה להיכנס לקורס של מורה אחר יועבר לעמוד רכישה
//   const canAccessCourse = (course: Course) => {
//     return user?.role === "Teacher" && course.teacherId === user.userId
//   }
