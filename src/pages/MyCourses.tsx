...
// // //       const filteredCourses = Array.isArray(userCourses)
// // //         ? userCourses.filter((folder: any) =>
// // //             folder.courseId != null &&
// // //             folder.lessonId == null &&
// // //             folder.teacherId != null &&
// // //             folder.title &&
...
// // //               <div className="flex space-x-2 space-x-reverse">
// // //                 <Link to={`/course/${course.courseId}`} className="flex-1 bg-blue-600 text-white text-center py-2 px-4 rounded-md hover:bg-blue-700 transition-colors flex items-center justify-center space-x-1 space-x-reverse">
// // //                   <Play className="h-4 w-4" />
// // //                   <span>צפה בקורס</span>
// // //                 </Link>
...
// //       const mappedCourses: Course[] = allCourses.map((folder: any) => {
// //         const isTeacher = user.userId === folder.teacherId
// //         const isPurchased = isTeacher || localStorage.getItem(`purchased_course_${folder.courseId}`) === "true"
...
// //       // הצג רק קורסים שנרכשו או שנוצרו ע"י המשתמש (אם הוא מורה)
// //       const visibleCourses = mappedCourses.filter(course => course.isPurchased)
...
// //       if (user.role === "Teacher") {
// //         // הצג רק קורסים שהמורה יצר
// //         filteredCourses = allCourses.filter((course: { teacherId: number }) => course.teacherId === user.userId)
// //       } else {
// //         // הצג רק קורסים שנרכשו ע"י המשתמש
// //         filteredCourses = allCourses.filter((course: { courseId: any }) =>
