...
//             <Circle className="h-10 w-10 text-green-500 mx-auto mb-4" />
//             <h3 className="text-xl font-bold text-gray-800 mb-2">הרשמה הושלמה בהצלחה!</h3>
//             <p className="text-sm text-gray-600 mb-4">
//               סיסמה נשלחה לכתובת הדוא"ל <span className="font-semibold text-blue-600">{formData.email}</span>
//             </p>
//             <button
//               onClick={() => navigate("/")}
//               className="mt-2 w-full py-2 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 font-semibold"
//             >
//               חזרה לדף הבית
//             </button>
//           </div>
...
const Register: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData(prev => ({
      ...prev,
      [e.target.name]: value,
      role: e.target.name === "isTeacher" && value ? "Teacher" : prev.role
    }))
  }
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    value={formData.userName}
                    onChange={handleChange}
                    className="block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 transition-all"
                    placeholder="הזן שם משתמש"
                  />
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-100">
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      name="isTeacher"
                      onChange={handleChange}
                      className="h-5 w-5 text-blue-600 border-gray-300 rounded transition-all"
                    />
                    <span className="mr-3 text-sm font-medium text-blue-800 flex items-center">
                      <GraduationCap className="h-4 w-4 ml-1" />
                      אני מורה
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 px-6 rounded-xl shadow-lg text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 font-semibold transition"
                >
                  {loading ? (
      ...
      {showSuccess && (
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">הרשמה הושלמה בהצלחה!</h3>
            <p className="text-sm text-gray-600 mb-4">
              סיסמה נשלחה לכתובת <span className="font-semibold text-blue-600">{formData.email}</span>
            </p>
            <button
              onClick={() => navigate("/")}
              className="w-full py-2 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow hover:from-blue-700 hover:to-indigo-700 font-semibold transition"
            >
              חזרה לדף הבית
            </button>
          </div>
